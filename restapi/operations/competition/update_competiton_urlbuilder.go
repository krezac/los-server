...
func (o *UpdateCompetitonURL) Build() (*url.URL, error) {
	...
	if competitionID != "" {
		...
		return nil, errors.New("CompetitionID is required on UpdateCompetitonURL")
	}
...
func (o *UpdateCompetitonURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateCompetitonURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateCompetitonURL")
	}

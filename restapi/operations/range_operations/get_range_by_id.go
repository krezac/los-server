...
type GetRangeByIDHandlerFunc func(GetRangeByIDParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRangeByIDHandlerFunc) Handle(params GetRangeByIDParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// GetRangeByIDHandler interface for that can handle valid get range by Id params
type GetRangeByIDHandler interface {
	Handle(GetRangeByIDParams, *models.Principal) middleware.Responder
}

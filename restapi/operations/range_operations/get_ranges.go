...
type GetRangesHandlerFunc func(GetRangesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRangesHandlerFunc) Handle(params GetRangesParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetRangesHandler interface for that can handle valid get ranges params
type GetRangesHandler interface {
	Handle(GetRangesParams, interface{}) middleware.Responder
}

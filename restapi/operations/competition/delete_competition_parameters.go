...
// NewDeleteCompetitionParams creates a new DeleteCompetitionParams object
// no default values defined in spec.
func NewDeleteCompetitionParams() DeleteCompetitionParams {

	return DeleteCompetitionParams{}
}

// DeleteCompetitionParams contains all the bound params for the delete competition operation
...
func (o *DeleteCompetitionParams) bindCompetitionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
